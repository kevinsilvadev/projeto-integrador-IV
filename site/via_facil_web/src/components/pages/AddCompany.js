            ...
            <div className="column">
              <div className="parcerias-container">
                <CardParcerias
                  ...
                  link={"https://login.sis.puc-campinas.edu.br/login?logout&layoutEnvLabel="}
                />
              </div>
            </div>
            <div className="column">
              <div className="parcerias-container">
                <CardParcerias
                  ...
                  link={"https://www.unimed.coop.br/site/segunda-via-de-boletos"}
                />
              </div>
            </div>
            <div className="column">
            ...
            <div className="column">
              <div className="parcerias-container">
                <CardParcerias
                  ...
                  link={"https://www.vivo.com.br/para-voce/ajuda/minha-fatura/2-via-de-fatura"}
                />
              </div>
            </div>
            <div className="column">
            ...
            <div className="column">
              <div className="parcerias-container">
                <CardParcerias
                  ...
                  link={"https://www.netflix.com/br/login?nextpage=https%3A%2F%2Fwww.netflix.com%2Fyouraccount"}
                />
              </div>
            </div>
          </div>
